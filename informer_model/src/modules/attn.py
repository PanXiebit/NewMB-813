...
from informer_model.src.utils import TriangularCausalMask, ProbMask
    ...
    def forward(self, queries, keys, values, attn_mask):
        ...
        if self.mask_flag:
            if attn_mask is None:
                # TODO? encoder 不需要 casual mask 吧？
...
class ProbAttention(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask):
        ...
        # print("U_part", self.factor * np.ceil(np.log(L_K)).astype('int').item())
